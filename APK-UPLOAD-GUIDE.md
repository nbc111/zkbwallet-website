...
### 系统架构
- **前端网站**: 部署在Vercel，提供用户界面
- **APK上传服务**: 部署在独立服务器，处理文件上传
- **APK下载服务**: 同一服务器提供文件下载
- **固定下载地址**: 无论APK如何更新，下载地址保持不变

## 固定下载地址

**APK下载地址**: `http://206.238.197.207:3333/down/zkbwallet.apk`
...
3. **访问上传界面**：
   - 地址: `http://206.238.197.207:3333/upload-apk.html`
   - 支持拖拽上传
   - 自动验证APK格式
   - 实时显示上传进度
